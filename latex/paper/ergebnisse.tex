...
\begin{table}[htbp]
    ...
    \vspace{3mm}
    \label{tab:faktoren}
        \begin{tabularx}{8.4cm}{@{\extracolsep{\fill}} @{\arrayrulewidth1.5pt\vline}l|Y@{\arrayrulewidth1.5pt\vline}l|Y@{\arrayrulewidth1.5pt\vline}}
            \multicolumn{2}{c}{1. Faktor: \textbf{Ruhig}} & \multicolumn{2}{c}{2. Faktor: \textbf{Niveauvoll}} \\
            ...
            \hline
            \multicolumn{2}{@{\arrayrulewidth1.5pt\vline}c@{\arrayrulewidth1.5pt\vline}}{}        & ~Intellektuell & ~0,669 \\
            \noalign{\hrule height1.5pt}
            \multicolumn{4}{c}{} \\
            \multicolumn{2}{c}{3. Faktor: \textbf{Heiter}} & \multicolumn{2}{c}{4. Faktor: \textbf{Energisch}} \\
            \noalign{\hrule height1.5pt}
            ~Fröhlich & ~0,855             & ~Erregend & ~0,838 \\
            \hline
            ~Traurig & -0,713           & ~Intensiv & ~0,656 \\
            \hline
            ~Tanzbar & ~0,680             & \multicolumn{2}{c@{\arrayrulewidth1.5pt\vline}}{} \\
            \noalign{\hrule height1.5pt}
        \end{tabularx}
\end{table}
