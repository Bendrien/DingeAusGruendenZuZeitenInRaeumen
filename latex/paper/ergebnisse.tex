...
\begin{table}[htbp]
    ...
    \vspace{2mm}
    \label{tab:faktoren}
        \begin{tabularx}{8.4cm}{@{\arrayrulewidth1.5pt\vline}lY@{\arrayrulewidth1.5pt\vline}lY@{\arrayrulewidth1.5pt\vline}}
            \noalign{\hrule height1.5pt}
            \multicolumn{2}{@{\arrayrulewidth1.5pt\vline}c@{\arrayrulewidth1.5pt\vline}}{1. Faktor: \textbf{Ruhig}} & \multicolumn{2}{c@{\arrayrulewidth1.5pt\vline}}{2. Faktor: \textbf{Niveauvoll}} \\
            \hline
            ...
            \noalign{\hrule height1.5pt}
            %\multicolumn{5}{c}{} \\
            \multicolumn{2}{@{\arrayrulewidth1.5pt\vline}c@{\arrayrulewidth1.5pt\vline}}{3. Faktor: \textbf{Heiter}} & \multicolumn{2}{c@{\arrayrulewidth1.5pt\vline}}{4. Faktor: \textbf{Energisch}} \\
            \hline
