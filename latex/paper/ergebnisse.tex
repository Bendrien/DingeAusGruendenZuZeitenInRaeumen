...
\begin{table}[htbp]
    ...
    \label{tab:DescriptiveTextForATable}
        \begin{tabularx}{8cm}{@{\extracolsep{\fill}} @{\arrayrulewidth1.5pt\vline}Y@{\arrayrulewidth1.5pt\vline}Y|l|l|l@{\arrayrulewidth1.5pt\vline}}
            \noalign{\hrule height1.5pt}
            Faktor & Modell & Beta & Sig. & $\text{R}^2$ \\
            \noalign{\hrule height1.5pt}
            \multirow{3}{*}{Ruhig} & Konstante & 0 & & \multirow{3}{*}{0,215} \\
                \cline{2-4}
                & energy & -0,434 & 0 & \\
                \cline{2-4}
                & speechiness & -0,1 & 0 & \\
